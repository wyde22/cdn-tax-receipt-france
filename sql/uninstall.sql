...
DROP TABLE IF EXISTS cdntaxreceiptsfr_log_contributions;
DROP TABLE IF EXISTS cdntaxreceiptsfr_log;
DROP TABLE IF EXISTS cdntaxreceiptsfr_advantage;
...
WHERE civicrm_option_group.name = 'msg_tpl_workflow_cdntaxreceiptsfr';

-- Delete custom template for reçu fiscal France
DELETE FROM civicrm_msg_template WHERE msg_title = 'CDN Tax Receipts FR - Reçu fiscal template';