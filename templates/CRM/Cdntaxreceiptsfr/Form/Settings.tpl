...
<h3>{ts domain='org.civicrm.cdntaxreceiptsfr'}Organization Details{/ts}</h3>
...
<h3>{ts domain='org.civicrm.cdntaxreceiptsfr'}Receipt Configuration{/ts}</h3>
